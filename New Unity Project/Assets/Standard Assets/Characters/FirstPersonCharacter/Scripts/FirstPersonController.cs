...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(equip_KeyCode))
            {
        ...
        private void grappleTransport(Transform obj)
        {
            ...
            Transform objPos = obj;
            Vector3 adjust = new Vector3(0,1,0);
            Vector3 targetPos;

            if (objPos.tag == "grappleSpot")
            {
                targetPos = objPos.transform.position + adjust;
                m_CharacterController.transform.position = targetPos;
            }
            else
            {
